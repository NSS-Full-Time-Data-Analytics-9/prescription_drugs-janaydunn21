...
SUM(total_claim_count) AS total_claimc
FROM prescription LEFT JOIN prescriber USING (npi)
GROUP BY specialty_description
ORDER BY total_claimc
LIMIT 1;
...
SELECT specialty_description,
SUM(total_claim_count) AS total_claimc
FROM prescription AS prescription_name 
LEFT JOIN prescriber AS prescriber_name USING(npi) LEFT JOIN drug AS opioids USING(drug_name)
...
--insulin glarigine, HUM.REC.ANLOG--
